...
export const Vr: React.SFC<VrProps> = ({id, index, trKey, style, className, ...props}) => {
  return (
    <tr {...props} data-id={id} data-index={index} data-key={trKey} style={style} className={className} role="row" />
  );
};
Vr.displayName = 'Vr';
export type VrProps = {
...
export const Vd: React.SFC<VdProps> = ({className, ...props}) => {
  return (
